...
import { getLedgerDashboardSummary, getMemberPayments, getOtherIncome } from "@/lib/DatabaseService";
...
export default function PrintCenter() {
  ...
  const printPeriodReport = async () => {
    ...
    try {
      const [other, accounting, periodMembers] = await Promise.all([getOtherIncome(selectedMonth, selectedYear), getLedgerDashboardSummary(selectedMonth, selectedYear), Promise.resolve(members.filter((member) => member.month === selectedMonth && member.year === selectedYear))]);
