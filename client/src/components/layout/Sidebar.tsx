...
import { LayoutDashboard, FileBarChart, Settings, Upload, Printer, Moon, LogOut, X, Landmark, ArrowLeftRight } from "lucide-react";
...
const nav = [
  ...
  { to: "/deposit", label: "Deposit", icon: ArrowLeftRight },
