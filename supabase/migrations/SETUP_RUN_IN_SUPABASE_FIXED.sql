-- ================================================================
-- MASJID RECEIPT MANAGER — FIXED SUPABASE SETUP
...
-- 5) auto-create profile and settings for new users
...
-- 6) atomic receipt sequence function
...
-- 7) backfill for existing authenticated users
